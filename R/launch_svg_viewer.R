    ...
    miniUI::miniContentPanel(
      htmltools::tags$div(
        ...
        htmltools::tags$div(
          ...
          htmltools::tags$div(
            class = "svg_toolbar_meta",
            htmltools::tags$span(id = "zoom_level", "100%"),
            htmltools::tags$span(class = "svg_toolbar_hint", "Drag to pan · Wheel to zoom")
          )
        ),
        htmltools::tags$div(
          id = "svg_viewport",
...
svg_viewer_js <- function() {
  paste(
    ...
    "    var label = document.getElementById('zoom_level');",
    "    if (!label) return;",
    "    var percentage = Math.round(state.scale * 100);",
